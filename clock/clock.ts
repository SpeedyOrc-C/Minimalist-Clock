...
let audioTick = document.querySelector<HTMLAudioElement>('#audio-tick')!
...
let checkboxPlayTick = document.querySelector<HTMLInputElement>('#checkbox-play-tick')!

checkboxPlayTick.addEventListener('click', _ =>
    config['play-tick'] = checkboxPlayTick.checked
)
